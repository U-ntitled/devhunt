       ...
       <div className=" flex flex-col space-y-14 w-[40%]">
            ...
            <div className="flex justify-between items-center">
                    ...
                    <input type='email' name='email' 
                        id='email' className='border border-none  w-[18vw] 
            ...
            <div className="flex-col space-y-4 w-[100%]">
                 <h3 className='text-[#868686] text-xl'>Mot de passe</h3>
                 <input type='password' name='password' 
                 id='password' className='border border-none  w-[100%] 
                   text-xl text-[#7B7777] bg-[#F2F2F2] h-[7vh] rounded-full focus:outline-none bg-none pl-10'
            ...
            <div className="w-[100%]">
                <button type="submit" className="bg-[#00CF35] w-[100%] h-[7vh] flex justify-center items-center rounded-full text-[#f2f2f2] text-2xl" >Se connecter</button>
            </div>
       </div>
    </div>
  )
